...
Definition big_product {C : Cat} {J : Set} {A : J -> Ob C} (P : Ob C)
    (p : forall j : J, Hom P (A j)) := forall (X : Ob C) (j : J) (f : Hom X (A j)),
    exists! u : Hom X P, f = u .> p j.

Definition big_coproduct {C : Cat} {J : Set} {A : J -> Ob C} (P : Ob C)
    (i : forall j : J, Hom (A j) P) := forall (X : Ob C) (j : J) (f : Hom (A j) X),
    exists! u : Hom P X, f = i j .> u.

Theorem big_proj_ret : forall (C : Cat) (J : Set) (A : J -> Ob C) (P : Ob C)
    (p : forall j : J, Hom P (A j)),
...
Theorem big_inj_sec : forall (C : Cat) (J : Set) (A : J -> Ob C) (P : Ob C)
...
Theorem nullary_prod : forall (C : Cat) (A : False -> Ob C) (T : Ob C)
